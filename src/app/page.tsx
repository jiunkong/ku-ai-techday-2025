        ...
        <>            
            <div className="px-5 lg:px-15 mt-15 w-screen">
                ...
                <div>
                    ...
                    <p className="mt-1">삼성전자, KT, LG AI 연구소, AWS, 네이버, 크래프톤</p>
                </div>
                <div className="mt-15 lg:mt-0 lg:absolute lg:top-0 lg:right-10 flex flex-col lg:items-end">
                    ...
                    <p className="mt-3 w-full lg:w-105">
                        고려대학교 ICT명품인재양성사업단/초지능연구센터는 작년에 이어 올해 10월 15일(수)에 AI Tech Day를 개최합니다.
                        본교 하나스퀘어에서 열리는 AI Tech Day 2025에서는 사업단 소속 교수들이 올해 발표한 top-tier conference 논문과
                        현재 진행 중인 연구를 결합하여 압축 발표하고, 정보통신기획평가원 원장과 KT, LG AI 연구소, 삼성전자, AWS, 네이버, 크래프톤의
