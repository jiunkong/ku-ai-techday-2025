        ...
        <div className="w-screen pt-30 text-black">
            ...
            <table className="mx-auto mt-10 border-separate border-spacing-x-4 table-fixed pb-40">
                ...
                <tbody>
                    ...
                    <Row start="10:10" end="10:40" program="K Intelligence: 한국적 AI로 여는 산업 혁신" organizer="배순민 AI Future Lab장/상무" note="KT"/>
                    ...
                    <Row start="14:40" end="15:10" program="Agentic AI on AWS" organizer="김경윤 Solution Architect Manager" note="AWS"/>
